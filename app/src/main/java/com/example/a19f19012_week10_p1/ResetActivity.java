            ...
            public void onClick(View v) {
                ...
                if (password.equals(repassword)) {
                    ...
                    if (checkpasswordupdate == true) {
                        ...
                        Toast.makeText(ResetActivity.this, "Password has been successfully updated!", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(ResetActivity.this, "Password has not been updated", Toast.LENGTH_SHORT).show();
                    }
                }else
                {
